...
public interface TeamRepository extends JpaRepository<Team, Long> {
    ...
    @Query("select b, r from Team b left join TeamReply r on r.trBoard = b where b.idx = :idx")
    ...
    @Query(value = "select b, u, count(r) " +
            "from Team b " +
            "left join b.tUser u " +
            "left join TeamReply r on r.trBoard = b " +
